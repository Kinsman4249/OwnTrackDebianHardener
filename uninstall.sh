...
#
# We call it as `bash <path>` rather than `<path>` directly so this works even
# when install.sh doesn't carry the executable bit (files pushed via the
# GitHub API are stored non-executable — see the README setup notes).
# =============================================================================
